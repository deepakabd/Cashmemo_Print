...
export default function AttendanceReportPage({ loggedInUser, onClose }) {
  ...
  return <section className="attendance-page attendance-report-page">
    <header className="attendance-hero"><div><p>PAYROLL REPORT</p><h1>Day-wise Attendance &amp; Wage Report</h1><span>Every date in the selected month is shown employee-wise.</span></div></header>
